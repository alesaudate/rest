package br.com.brejaonline.services.test;
...
import br.com.brejaonline.services.ApplicationJAXRS;
import br.com.brejaonline.services.test.model.Cervejas;
import br.com.brejaonline.services.test.model.Constants;
...
public class CervejaServiceIT extends JerseyTest {
	...
	@Test
	public void testHappyDay() throws UnsupportedEncodingException {
		...
		assertEquals(
				Constants.CAMINHO_COMPLETO + "cervejas/Erdinger Weissbier",
				URLDecoder.decode(link1.getUri().toASCIIString(), "UTF-8"));
		assertEquals(Constants.CAMINHO_COMPLETO + "cervejas/Stella Artois",
